...
<div class="form-wrap">
	...
	<form name="IR_form" method="post" action="#" onsubmit="return IR_submit()"  >
      ...
      <input name="IR_path" type="text" id="IR_path" value="" size="80" maxlength="1024" />
      ...
      <input name="IR_link" type="text" id="IR_link" value="" size="80" maxlength="1024" />
      ...
      <input name="IR_title" type="text" id="IR_title" value="" size="80" maxlength="200" />
      ...
      <input name="IR_desc" type="text" id="IR_desc" value="" size="80" maxlength="1024" />
